...
// }
// console.log(
//   `Agadir depassera Marrakech au bout de ${year} le nombre d'habitant d'agadir est ${agd} alors que celui de marrakech est de ${mar} `
// );

// // Boucle a itération definies (for)
// // L'ordre de for(initialisation; condition; incrementation)
...
// // Ecrire un algorithme qui affiche les nombre pairs de 0 à 100

// // for(let pair = 0; pair <= 100; pair=pair+2){
// //     console.log(pair)
// // }
...
// // transformez la fonction pour la rendre parametrable et pouvoir decider jusqu'à quel nombre de boucle se fait

// function turn(r, y) {
//   for (let pir = 0; pir <= r; pir = pir + y) {
//     console.log(`${pir}`);
//   }
// }
...
// /* Un tableau (array) est un type de donnée qui peut contenir plusieurs elements
//    On peut créer un tableau en utilisant des crochets[] et en y inserant les element separés par des virgules
//    */
...
// // On peut acceder à un element du tableau en utilisant son index numerique (indice)
// // L'index du premier élément est toujours 0
// console.log(week[0])

// // Pour modifier la valeur d'un element d'un tableau, je precise l'indice
// week[6] = 'test'
// console.log(week)

// // Pour connaitre la longueur  d'un tableau nous pouvons utiliser la prpopriété .length
// console.log(week.length + 1)

// // tableau animals
// // 6 animaux dedans afficher le premier et le dernier
// let animal = ['tigre', 'lion', 'chat', 'panthere', 'aigle', 'chien']
...
// //  Affiche tous les element du tableau animals
...
// // Les tableaux oeuvent contenir des tableaux
